...
from .views import Homepage, Homevozes, Detalhesvoz, Pesquisa, Editarperfil, Editardublador, AdicionarDubladorView
...
urlpatterns = [
   ...
   # path('vozes/', buscar, name='buscar'),
    ...
    path('adicionar-dublador/', AdicionarDubladorView.as_view(), name="adicionar_dublador"),
